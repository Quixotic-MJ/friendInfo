...
const roy = require("./assets/profile/jpnoq.jpg");

const ProfileScreen = () => {
  const router = useRouter();

  const profileData = {
    name: " Jhon Paul Noquiana",
    role: "BSIT Student",
    location: "Maharuhay, Medellin, Cebu",
    birthday: "October 2, 2005",
    email: "jpaulnoquiana2@gmail.com",
    phone: "09947195660",
    bio: "I am a dedicated Bachelor of Science in Information Technology (BSIT) student with a strong passion for technology and continuous learning. I am committed to developing my skills in programming, systems development, and innovation to prepare myself for the professional world. My goal is to build a successful and impactful career in the IT industry while continuously growing both personally and professionally.",
  };
